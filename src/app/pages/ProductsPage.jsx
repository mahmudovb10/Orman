...
export function ProductsPage({ onProductClick }) {
  ...
  return (
    <>
      <Helmet>
        <title>Orman | Mahsulotlar</title>
        <meta
          name="description"
          content="Qo‘lda ishlangan nafis lyustralar va yog‘och mahsulotlar katalogi. Narxlar va mahsulotlar bilan tanishing."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto text-gray-600">
              Bizning qo'lda ishlangan nafis qandillar va yog'ochdan
              tayyorlangan buyumlar to'plamini ko'rib chiqing
            </p>
          </div>
